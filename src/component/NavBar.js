...
const NavBar = () => {
  const { mode, toggleMode } = useThemeSwitcher(); // Use the hook to get the current theme mode
  ...
  return (
    <header
      className="w-full px-32 py-8 font-medium items-center justify-between
    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <button
            onClick={toggleMode} // Use the toggleMode function from useThemeSwitcher
    ...
    >
      <nav className="flex items-center flex-col justify-center">
        ...
        <CustomMobileLink href="/articles" title="Drawings" classname="" toggle={handleClick}/>
      </nav>
